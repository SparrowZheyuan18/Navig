...
- VLMs weight: The weight files are in [link](https://huggingface.co/XXX), download them and replace 'vlms/*/checkpoint-534' folder. The model file can download from huggingface soon.
